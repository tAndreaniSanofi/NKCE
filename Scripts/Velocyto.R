...
#example merge some random loom files
looms <- list.files('/cloud-data/snf-mgln-dds/AIDA/Bioinformatics/i0439277/NKp46/new_data_07_03_2022_parallel/loom_files/merge_test/', full.names = TRUE) %>% 
...
saveRDS(looms, '../merge_test/merged_03_06_12_14.loom')




#load velocyto loom file
ldat <- ReadVelocity("/cloud-data/snf-mgln-dds/AIDA/Bioinformatics/i0439277/NKp46/new_data_07_03_2022_parallel/loom_files/test.loom")


#extract differentially expressed genes in NKp46 or CTRL_Ab
genes <- read.table("cloud-data/snf-mgln-dds/AIDA/Bioinformatics/i0439277/NKp46/markers_RNA_forclusters_sample8_NKp46.txt")
